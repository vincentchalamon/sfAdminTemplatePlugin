...
<div class="contentcontainer">
  ...
  [?php include_partial('<?php echo $this->getModuleName() ?>/form_'.$configuration->getNewTemplate(), array('<?php echo $this->getSingularName() ?>' => $<?php echo $this->getSingularName() ?>, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?]
</div>
